...
public class UnicornStoreSpringEKSApp extends Construct {

    public UnicornStoreSpringEKSApp(final Construct scope, final String id,
        InfrastructureStack infrastructureStack, UnicornStoreSpringEKS unicornStoreSpringEKS) {
        super(scope, id);

        private final Cluster cluster = unicornStoreSpringEKS.getCluster();

        final String projectName = "unicorn-store-spring";

        // App
        Namespace ns = Namespace.Builder.create(scope, projectName + "-ns")
        ...
        ServiceAccount sa = ServiceAccount.Builder.create(scope, projectName + "-sa")
                .metadata(ApiObjectMetadata.builder()
                        .name(projectName + "-sa")
