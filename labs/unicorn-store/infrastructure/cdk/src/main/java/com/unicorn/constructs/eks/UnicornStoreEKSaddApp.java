                                        ...
                                        List.of(Map.of("resources",
                                                ...
                                                List.of(Map.of("name", "SPRING_DATASOURCE_PASSWORD",
                                                        ...
                                                        Map.of("name",
                                                                ...
                                                                "value", "1"),
                                                        Map.of("name", "OTEL_OTLP_ENDPOINT",
                                                                "value", "localhost:4317"),
                                                        Map.of("name", "OTEL_RESOURCE_ATTRIBUTES",
                                                                "value",
                                                                "service.namespace=AWSObservability,service.name=unicorn-store-spring"),
                                                        Map.of("name", "S3_REGION", "value",
                                                                infrastructureStack.getRegion()),
                                                        Map.of("name", "OTEL_METRICS_EXPORTER",
                                                                "value", "otlp")),
