...
public class UnicornStoreEKSaddFargate extends Construct {
    ...
    public UnicornStoreEKSaddFargate(final Construct scope, final String id,
        ...
        // Implementation of k8s Namespace and ConfigMap using KubernetesManifest CDK contstruct
        ...
        // Implementation of k8s Namespace and ConfigMap using cdk8s and cdk8s.plus25 approach
